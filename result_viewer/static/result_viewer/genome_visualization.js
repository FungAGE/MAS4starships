// Global variables
let svg, genome_vis, s, scale_vertical, zoom, genome_xAxis, yAxis;
...
function drawFeatures() {
  const features = genome_vis.selectAll(".feature")
...
function addAccessibility() {
  svg.attr("role", "img")
     .attr("aria-label", "Genome visualization")
     .attr("tabindex", 0);
...
function redrawVisualization() {
  // Update axes
  genome_vis.select(".x-axis").call(genome_xAxis);
  genome_vis.select(".y-axis").call(yAxis);
