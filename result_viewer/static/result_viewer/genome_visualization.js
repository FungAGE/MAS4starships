$(document).ready(function () {
  ...
  var s = d3.scaleLinear().domain([0, GENOME_LENGTH]).range([0, width])

  var scale_vertical = d3.scaleLinear().domain([2, 0]).range([0, 50])
  ...
  var genome_xAxis = d3.axisBottom().scale(s)
  ...
  function zoomed() {
    ...
    genome_vis.transition().duration(0).call(genome_xAxis.scale(new_x_scale))
