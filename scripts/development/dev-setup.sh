...
echo "HTTPS on the LAN: generate certs with scripts/reverse-proxy/issue-mkcert.sh, then"
echo "  export MAS_BEHIND_HTTPS_PROXY=1"
echo "  ./scripts/reverse-proxy/run-caddy.sh   (in another terminal)"
