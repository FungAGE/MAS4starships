...
mamba create -y --name mas-worker -c conda-forge -y python=3.8 mysqlclient
conda activate mas-worker;
mamba install -c bioconda -c conda-forge glimmer=3.02 blast=2.9.0 trnascan-se=2.0.6 hhsuite;
